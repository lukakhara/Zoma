  ...
  const ProductPage = () => {
    ...
    const productDataFromTranslation = t("products", {returnObjects: true, }) as CartItem[];
    ...
    const mergeProduct = { ...tranlsationSelectedData, ...myNeededProduct, selectedCapacityIndex: 0, amount: 1 };
    ...
    function updateQuantity(amount: number) {
      ...
      console.log("selectedCapacityIndex", product.capacities[product.selectedCapacityIndex]);
      console.log("amount", product.amount);

  //   useEffect(() => {
  //   setProduct(mergeProduct);
  // }, [id]); // re-sync if route id changes
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="">
                ...
                <span className="bg-red-100 text-white text-xs font-semibold px-2 py-0.5 rounded">
                  -{(((capacity.price - capacity.finalPrice))*product.amount).toFixed(2)}
                  ₾
                </span>
              </div>
