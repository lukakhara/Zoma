...
const UserProfile = () => {
  ...
  const fields = [
    ...
    {
      label: t("email"),
      hint: t("mustBeAValidEmailAddressE_GNameExampleCom"),
      value: email,
      setter: setEmail,
      type: "email",
    },
    {
      label: t("password"),
      hint: t("LeaveBlankToKeepYourCurrentPasswordAtLeast8CharactersIfChangingIt"),
      value: password,
      setter: setPassword,
      type: "password",
    },
    {
      ...
      hint: t("MustMatchThePasswordAbove"),
