  ...
  return (
    <>
     ...
     {/* name and category and prices  */}
        <div className="flex  flex-col  font-helvetocaRegular pl-[19px] gap-[3px] desktop:pl-[0px]  desktop:ml-[19px] desktop:mr-[12px]   -mt-5">
      {/* name and category */}
          <div className=" text-[#DDDDDD] text-[10px] desktop:text-[8.91px] category leading-[100%] ">
            {product.category}
          </div>
          <div className="text-[#1A1A1A] text-[14px] desktop:text-[12.48px] leading-[100%]">
            {product.name}
          </div>
          {/* prices */}
          <div className="flex items-center  gap-2 text-nowrap">
            <p className="bg-[#FDE800] text-[20px] desktop:text-[17.82px] text-[#474747]
             font-helvetocaMedium p-2 rounded-sm leading-[12.19px] desktop:p-[7.13px] ">
              {product.finalPrice}{" "}
        ...
        <div className="flex items-baseline  gap-2 desktop:gap-[7.13px] justify-between  mb-[10px] ml-[15px] mr-[16px]  ">
          <div className=" relative  h-[33px] desktop:mt-2.5   rounded-[100px]   bg-[#F2F2F2]  desktop:w-[50.79px] desktop:h-[29.41px] flex items-center justify-center   gap-1.5 w-[57px]">
            <select
              className="
